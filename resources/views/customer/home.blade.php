    ...
    <main id="products" class="max-w-7xl mx-auto p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach ($products as $product)
                    <div class="product-card bg-white shadow rounded-lg p-6 flex flex-col">
                        <img src="https://placehold.co/600x400" alt="Placeholder" class="w-full h-48 object-cover mb-4 rounded">
